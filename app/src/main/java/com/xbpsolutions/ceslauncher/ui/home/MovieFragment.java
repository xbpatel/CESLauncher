...
import com.xbpsolutions.ceslauncher.ui.home.adapter.RevisedAppListAdapter;
...
public class MovieFragment extends Fragment implements
    ...
    private void setAdapterByName(ArrayList<AppModel> apps) {
        ...
        RevisedAppListAdapter revisedAppListAdapter = new RevisedAppListAdapter(getActivity(), apps);
        recyclerView.setAdapter(revisedAppListAdapter);
        revisedAppListAdapter.setOnSetClicksListner(new RevisedAppListAdapter.OnSetClicks() {
            @Override
            public void onClick(int position) {
                AppModel app = movieList.get(position);
