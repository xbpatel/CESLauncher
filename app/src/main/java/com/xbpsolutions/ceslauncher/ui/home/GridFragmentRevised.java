 ...
 */
public class GridFragmentRevised extends Fragment {
  ...
  private BaseAppsAdapter baseAppsAdapter;
  GridLayoutManager gridLayoutManager;

  public GridFragmentRevised() {
  }
   ...
   */
  public void setGridAdapter(BaseAppsAdapter adapter) {
    final boolean hadAdapter = (baseAppsAdapter != null);
    baseAppsAdapter = adapter;
  ...
  public void setSelection(int position) {
    ensureGrid();
    // recyclerView.setSelection(position);//// TODO: 07-03-2017  
  }
   ...
   * showing it once an adapter is given with {@link #(ListAdapter)}.
   * If the grid at that point had not been shown, when it does get shown
   * it will be do without the user ever seeing the hidden state.
   *
   * @param shown If true, the grid view is shown; if false, the progress indicator.  The initial
   * value is true.
   */
   ...
   */
  public BaseAppsAdapter getGridAdapter() {
  ...
  private void ensureGrid() {
    ...
    if (root instanceof RecyclerView) {
      ...
      recyclerView = (RecyclerView) rawGridView;
//      if (mEmptyView != null) { //// TODO: 07-03-2017
...
//      }
    ...
    mGridShown = true;
    //  recyclerView.setOnItemClickListener(mOnClickListener);
    if (baseAppsAdapter != null) {
      AppsAdapterByName adapter = (AppsAdapterByName) baseAppsAdapter;
      baseAppsAdapter = null;
