package com.xbpsolutions.ceslauncher.tabwidget;
...
public class TabBarView extends LinearLayout {
  ...
  public void setStripColors(ArrayList<String> stripColors) {
    this.stripColors = stripColors;
  }

  private ArrayList<String> stripColors;
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (child != null) {
      ...
      mPaint.setColor(Color.parseColor(stripColors.get(mSelectedTab)));
      Log.e("Color", "" + stripColors.get(mSelectedTab));
      canvas.drawRect(left, height - mStripHeight, right, height - 2, mPaint);
      mPaint.setColor(Color.WHITE);
    }
  }
